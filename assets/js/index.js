  ...
  for (const [index, movie] of movieList.entries()) {
    ...
    sliderItem.innerHTML = `
      ...
      <div class="banner-content">
        ...
        <a href="./detail.html" class="btn" onclick="getMovieDetail(${id})"><img src="./assets/images/play_circle.png" width="24" height="24" aria-hidden="true" alt="play circle" /> <span class="span">Watch Now</span></a>
      </div>
    `;
