...
export function sidebar() {
  ...
  sidebarInner.innerHTML = `
    ...
    <div class="sidebar-list">
      ...
      <a href="./movie-list.html" menu-close class="sidebar-link" onclick='getMovieList("with_original_language=tl", "Tagalog")'>Tagalog</a>
      <a href="./movie-list.html" menu-close class="sidebar-link" onclick='getMovieList("with_original_language=hi", "Hindi")'>Hindi</a>
    </div>

    <div class="sidebar-footer">
      <p class="copyright">Copyright 2023 <a href="https://github.com/sktt1faker02">sktt1faker</a></p>
